...
<head>
  ...
  <meta name="csrf-token" content="j15rdIW2kC2MzOYV5xV4gQXPs9AbLpIt9rYX4cDI">
    <title>LegalTradeMining - Deposit Wallet Transactions</title>
...
Our goal is to provide our investors with a reliable source of high income, while minimizing any possible risks and offering a high-quality service, allowing us to automate and simplify the relations between the investors and the trustees. We work towards increasing your profit margin by profitable investment. We look forward to you being part of our community.">
    ...
    <meta name="apple-mobile-web-app-title" content="LegalTradeMining - Deposit Wallet Transactions">
    
    <meta itemprop="name" content="LegalTradeMining - Deposit Wallet Transactions">
...
Our goal is to provide our investors with a reliable source of high income, while minimizing any possible risks and offering a high-quality service, allowing us to automate and simplify the relations between the investors and the trustees. We work towards increasing your profit margin by profitable investment. We look forward to you being part of our community.">
    ...
    <meta property="og:url" content="https://legaltrademining.com/user/transactions/deposit-wallet">
                ...
                <div class="col-md-12">
                    <div class="right float-right mb-5">
                        ...
                        <a href="
                                                ...
                                                https://legaltrademining.com/user/transactions/interest-wallet
                    ...
                    <div class="table-responsive--md">
                        <table class="table style--two">
                            ...
                            <tbody>
                                                            <tr>
                                    <td data-label="Date">
                                        23 nov., 2023 10:23 a. m.
                                    </td>
                                    <td  data-label="#Trx">6YR5ZH8B8Y8J</td>
                                    <td data-label="Details">You have got Sign Up Bonus</td>
                                    <td data-label="Amount">
                                        <strong  class="text-success" > + 10 Dollars</strong>
                                    </td>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 text-md-left text-center">
          ...
          </p></p> Email: <font color="lightblue"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1665636666796462567a7371777a62647772737b7f787f78713875797b">[email&#160;protected]</a></font></p></p>
