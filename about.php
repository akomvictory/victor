...
<!-- Mirrored from legaltrademining.com/about by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2023 00:30:50 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="csrf-token" content="UhC8v8YlB6AcWrQD3TqfoVFNc4uQzISRlTbb1p8c">
    <title>LegalTradeMining - About</title>
...
Our goal is to provide our investors with a reliable source of high income, while minimizing any possible risks and offering a high-quality service, allowing us to automate and simplify the relations between the investors and the trustees. We work towards increasing your profit margin by profitable investment. We look forward to you being part of our community.">
    ...
    <meta name="apple-mobile-web-app-title" content="LegalTradeMining - About">
    
    <meta itemprop="name" content="LegalTradeMining - About">
...
Our goal is to provide our investors with a reliable source of high income, while minimizing any possible risks and offering a high-quality service, allowing us to automate and simplify the relations between the investors and the trustees. We work towards increasing your profit margin by profitable investment. We look forward to you being part of our community.">
    ...
    <meta property="og:url" content="https://legaltrademining.com/about">
...
?>
  <!-- header-section end  -->
    ...
    <!-- inner hero end -->
                        <section class="pt-120 pb-120 bg_img" data-background="https://legaltrademining.com/assets/images/frontend/how_work/5fce39883b22c1607350664.jpg">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <div class="section-header">
              <h2 class="section-title"><span class="font-weight-normal">How</span> <b class="base--color">LegalTradeMining</b> <span class="font-weight-normal">Works</span></h2>
        ...
        <div class="row justify-content-center mb-none-30">
            ...
            <div class="work-card text-center">
              ...
              <div class="work-card__content">
                <h4 class="base--color mb-3">Sign Up</h4>
              </div>
            </div><!-- work-card end -->
          </div>
                    <div class="col-lg-4 col-md-6 work-item mb-30">
    ...
    </section>                    <section class="about-section pt-120 pb-120 bg_img" data-background="https://legaltrademining.com/assets/images/frontend/about/60b60b6574cd91622543205.jpg">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 offset-lg-6">
            <div class="about-content">
              <h2 class="section-title mb-3"><span class="font-weight-normal">About</span> <b class="base--color">Us</b></h2>
              <p>We are an international financial company engaged in investment activities, which are related to trading on financial markets and cryptocurrency exchanges performed by qualified professional traders.<br />
<br />
          ...
          <div class="col-lg-8">
            <div class="accordion cmn-accordion" id="accordionExample">
                ...
                <div class="card-header" id="heading5">
                  <h2 class="mb-0">
                    <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse5" aria-expanded="false" aria-controls="collapse5">
                      <i class="las la-question-circle"></i>
                      <span>Can I register without deposit?</span>
                    </button>
                  </h2>
                </div>
                ...
                <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordionExample" style="">
                  <div class="card-body">
                    Yes, you don't need to make deposit to register! You can register your account without deposit, but won't be eligable to make profit from trades.                  </div>
                </div>
              </div>
                            <div class="card">
                <div class="card-header" id="heading6">
                  <h2 class="mb-0">
                    <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
                      <i class="las la-question-circle"></i>
                      <span>How can I deposit funds into my account?</span>
                    </button>
                  </h2>
                </div>
                ...
                <div id="collapse6" class="collapse" aria-labelledby="heading6" data-parent="#accordionExample" style="">
                  <div class="card-body">
                    All funds are deposited in bitcoin , so you will have to purchase the investment amount in bitcoin and have it sent to your personal investor wallet address.                  </div>
                </div>
              </div>
                            <div class="card">
                <div class="card-header" id="heading7">
                  <h2 class="mb-0">
                    <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse7" aria-expanded="false" aria-controls="collapse7">
                      <i class="las la-question-circle"></i>
                      <span>Where can I find my investor ID/ wallet address?</span>
                    </button>
                  </h2>
                </div>
                ...
                <div id="collapse7" class="collapse" aria-labelledby="heading7" data-parent="#accordionExample" style="">
                  <div class="card-body">
                    Immediately after signing up, your personal investor ID/Wallet Address can be seen on your Dashboard after you login.                  </div>
                </div>
              </div>
                            <div class="card">
                <div class="card-header" id="heading8">
                  <h2 class="mb-0">
                    <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse8" aria-expanded="false" aria-controls="collapse8">
                      <i class="las la-question-circle"></i>
                      <span>How long does it take to process my deposit?</span>
                    </button>
                  </h2>
                </div>
            
                <div id="collapse8" class="collapse" aria-labelledby="heading8" data-parent="#accordionExample" style="">
                  <div class="card-body">
                    An hour (max).                  </div>
                </div>
              </div>
                ...
                <div class="card-header" id="heading9">
                  <h2 class="mb-0">
                    <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse9" aria-expanded="false" aria-controls="collapse9">
                      <i class="las la-question-circle"></i>
                      <span>Are we a financial pyramid?</span>
                    </button>
                  </h2>
                </div>
            
                <div id="collapse9" class="collapse" aria-labelledby="heading9" data-parent="#accordionExample" style="">
                  <div class="card-body">
                    No, it isn't. we offer our clients strategies that have been proven over many years of offline and online work                  </div>
                </div>
              </div>
                            <div class="card">
                <div class="card-header" id="heading10">
                  <h2 class="mb-0">
                    <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse10" aria-expanded="false" aria-controls="collapse10">
                      <i class="las la-question-circle"></i>
                      <span>Does my trading manager have access to my funds?</span>
                    </button>
                  </h2>
                </div>
            
                <div id="collapse10" class="collapse" aria-labelledby="heading10" data-parent="#accordionExample" style="">
                  <div class="card-body">
                    No – they never have access to your account. Trading Managers only manage the trades carried out on your account.                  </div>
                </div>
              </div>
                            <div class="card">
                <div class="card-header" id="heading11">
                  <h2 class="mb-0">
                    <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse11" aria-expanded="false" aria-controls="collapse11">
                      <i class="las la-question-circle"></i>
                      <span>Is depositing safe and secure?</span>
                    </button>
                  </h2>
                </div>
            
                <div id="collapse11" class="collapse" aria-labelledby="heading11" data-parent="#accordionExample" style="">
                  <div class="card-body">
                    Yes depositing money to your account is absolutely safe, private, and secure. All transactions are communicated using Secure Socket Layer(SSL) technology, ensuring that your personal information is safe.                  </div>
                </div>
              </div>
                            <div class="card">
                <div class="card-header" id="heading12">
                  <h2 class="mb-0">
                    <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse12" aria-expanded="false" aria-controls="collapse12">
                      <i class="las la-question-circle"></i>
                      <span>Can i lose my investment with this platform?</span>
                    </button>
                  </h2>
                </div>
            
                <div id="collapse12" class="collapse" aria-labelledby="heading12" data-parent="#accordionExample" style="">
                  <div class="card-body">
                    All funds are traded securely and only on 98% sure signals. Even in the case of an unexpected incident, you can't lose your initial capital.                  </div>
                </div>
              </div>
                            <div class="card">
                ...
                <div id="collapse13" class="collapse" aria-labelledby="heading13" data-parent="#accordionExample" style="">
                  <div class="card-body">
                    No – they can never have access to withdraw your account funds. Trading Managers only manage the trades carried out on your account.                  </div>
                </div>
              </div>
                          </div>
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 text-md-left text-center">
          ...
          </p></p> Email: <font color="lightblue"><a href="cdn-cgi/l/email-protection.php" class="__cf_email__" data-cfemail="3f4c4a4f4f504d4b7f535a585e534b4d5e5b5a525651565158115c5052">[email&#160;protected]</a></font></p></p>
