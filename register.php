    ...
    <div class="header__bottom">
      <div class="container">
        <nav class="navbar navbar-expand-xl p-0 align-items-center">
          <a class="site-logo site-title" href="index.php"><img src="assets/images/logoIcon/logo.png" alt="site-logo"></a>
          <ul class="account-menu responsive-account-menu ml-3">
                        <a class="__tL" href="register.php">SIGN UP</a> <a class="__tL" href="login.php">LOGIN</a>
                      </ul> 
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="nav-right">
              <ul class="account-menu ml-3">
                ...
                <a class="__tL" href="register.php">SIGN UP</a>
  ...
  <!-- header-section end  -->
            ...
            <div class="account-card">
              ...
              <div class="account-card__body">
                <form action="register.php" class="mt-4"  method="post">
                  ...
                  <div class="form-group">
        <link href="https://fonts.googleapis.com/css?family=Henny+Penny&amp;display=swap" rel="stylesheet"><div style="height: 46px; line-height: 46px; width:100%; text-align: center; background-color: #003; color: #0478ea!important; font-size: 26px; font-weight: bold; letter-spacing: 20px; font-family: 'Henny Penny', cursive;  -webkit-user-select: none; -moz-user-select: none;-ms-user-select: none;user-select: none;  display: flex; justify-content: center;" class="captcha"><span style="    float:left;     -webkit-transform: rotate(43deg);">1</span><span style="    float:left;     -webkit-transform: rotate(-36deg);">2</span><span style="    float:left;     -webkit-transform: rotate(-40deg);">8</span><span style="    float:left;     -webkit-transform: rotate(22deg);">5</span><span style="    float:left;     -webkit-transform: rotate(26deg);">2</span><span style="    float:left;     -webkit-transform: rotate(19deg);">2</span></div><input type="hidden" name="captcha_secret" value="51c6e3e4b0f171fc2114c6d25d8754cac5872f72b12b7342a773992d5f4298d2">    </div>
    ...
    <div class="form-group">
        <input type="text" name="captcha" class="form-control" placeholder="Enter code" autocomplete="off" required>
                    ...
                    <a class="base--color" href="links/privacy-amp-policy/180.php"> Privacy &amp; Policy</a>
                     ,   
                    <a class="base--color" href="links/terms-amp-condition/181.php"> Terms &amp; Condition</a>
                     </span>
                    </div>
                  </div>
                  <div class="mt-3">
                    <button type="submit" name="signup_one" class="cmn-btn">SignUp Now</button>
                  </div>
                  <div class="form-row mt-2">
                    <div class="col-sm-6">
